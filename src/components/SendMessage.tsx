...
const SendMessage = ({RoomID,userID}:{RoomID:number,userID: number | undefined}) => {
  return (
    <div className="flex bg-white justify-evenly items-center h-[70%] w-[85%] md:w-full lg:h-[80%] rounded-[16px]
      focus-within:outline focus-within:outline-2 focus-within:outline-[#175DFF]">
        ...
        >
          ...
          <textarea className='w-[87%] h-full lg:text-lg lg:p-5 p-2 px-3 resize-none focus:outline-none rounded-xl text-black overflow-hidden' 
